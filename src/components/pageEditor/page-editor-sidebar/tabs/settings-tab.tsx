...
export default function SettingsTab() {
  ...
  const [activeStyle, setActiveStyle] = useState<customSettings>({});
  ...
  useEffect(() => {
    ...
    let newActiveStyle = { ...styles.styles }; // Start with base styles
  
    if (device === "Desktop" || !styles.mediaQuerys) {
    ...
    if (device === "Tablet") {
      ...
      if (tabletStyle) {
        newActiveStyle = { ...newActiveStyle, ...tabletStyle.styles };
      }
    }
    ...
    if (device === "Mobile") {
      ...
      if (mobileStyle) {
        newActiveStyle = { ...newActiveStyle, ...mobileStyle.styles };
      }
    }

    setActiveStyle(newActiveStyle);

  }, [state.editor.device, state.editor.selectedElement, state.editor.elements]);
