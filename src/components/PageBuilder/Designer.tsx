...
import { addElement, removeElement, setSelectedElement } from "@/redux/pageBuilder/PageBuilderSlice"; // Update the path
...
function Designer() {
  ...
  const { elements, selectedElement } = useAppSelector((state) => state.pageBuilder);
